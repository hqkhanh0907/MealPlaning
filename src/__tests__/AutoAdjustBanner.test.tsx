...
import {
  AutoAdjustBanner,
} from '../features/dashboard/components/AutoAdjustBanner';
...
describe('AutoAdjustBanner', () => {
  ...
  it('renders apply and dismiss buttons', () => {
    ...
    expect(screen.getByTestId('banner-apply-btn')).toHaveTextContent(
      'Áp dụng',
    );
    expect(screen.getByTestId('banner-dismiss-btn')).toHaveTextContent(
      'Bỏ qua',
    );
  });
  ...
  it('has role="alert" for accessibility', () => {
    ...
    expect(screen.getByTestId('auto-adjust-banner')).toHaveAttribute(
      'role',
      'alert',
    );
  });
