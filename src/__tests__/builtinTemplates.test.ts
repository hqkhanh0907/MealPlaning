...
import type { PlanTemplate, MuscleGroup, EquipmentType, SplitType } from '../features/fitness/types';
...
describe('BUILTIN_TEMPLATES', () => {
  ...
  it.each(BUILTIN_TEMPLATES.map((t) => [t.id, t]))('template "%s" dayConfigs length matches daysPerWeek', (_id, template) => {
    const t = template as PlanTemplate;
