  ...
  return (
    <div className="bg-card flex h-full flex-col">
      ...
      <div className="pt-safe bg-primary border-border flex items-center gap-2 border-b px-4 py-3">
        ...
        <h1 className="text-primary-foreground truncate text-xl font-semibold">{t('fitness.splitChanger.title')}</h1>
      </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className={`flex w-full items-start gap-3 rounded-xl border-2 p-4 text-left transition-colors ${
                  mode === 'regenerate' ? 'border-warning bg-warning/10' : 'bg-card border-border'
                } touch-manipulation`}
