      ...
      <div className="bg-card w-full max-w-sm rounded-2xl p-6" data-testid="custom-exercise-modal">
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="mt-4 space-y-3">
          ...
          <div className="mt-4 flex gap-3">
            ...
            <button
              type="submit"
              className="focus-visible:ring-ring bg-info hover:bg-info/90 flex min-h-[44px] flex-1 items-center justify-center rounded-lg py-2 text-sm text-white transition-colors focus-visible:ring-2 focus-visible:outline-none disabled:opacity-50"
