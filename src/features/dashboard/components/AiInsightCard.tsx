...
const COLOR_MAP: Record<InsightColor, ColorConfig> = {
  ...
  green: {
    ...
    action: 'text-primary-emphasis hover:bg-emerald-100 dark:hover:bg-emerald-900/20',
  ...
  gray: {
    ...
    action: 'text-foreground-secondary hover:bg-slate-100 dark:hover:bg-slate-700/50',
    dismiss: 'text-slate-400 dark:text-slate-500 hover:text-foreground-secondary dark:hover:text-slate-300',
  },
};
