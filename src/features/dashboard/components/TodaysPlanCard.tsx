        ...
        {mealSlots.map(slot =>
          slot.hasFood ? (
            <span
              ...
              className="text-primary bg-primary/10 flex items-center gap-1 rounded-full px-1.5 py-0.5 text-xs font-medium"
            >
            ...
            <button
              ...
              data-testid={`meal-slot-${slot.type}`}
              onClick={onAddMeal}
              className="text-info hover:bg-info/10 flex items-center gap-1 rounded-full border border-dashed border-current px-1.5 py-0.5 text-xs font-medium transition-colors"
            >
        ...
        <div data-testid="todays-plan-card" className={CARD_CLASS}>
          ...
          <div data-testid="workout-section">
            <div className="mb-1.5 flex items-center gap-1.5">
              ...
              <span className="text-foreground-secondary text-xs font-medium">{t('dashboard.todaysPlan.workout')}</span>
            </div>
            {data.workoutType && (
