                ...
                >
                  <div className="mb-3 flex items-start justify-between">
                    ...
                    <button
                      ...
                      className="bg-ai-subtle text-ai hover:bg-ai/10 flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-semibold transition-all disabled:opacity-50"
                    >
