...
export const initialIngredients: Ingredient[] = [
  ...
  {
    id: 'i4',
    name: { vi: 'Sữa chua Hy Lạp', en: 'Greek yogurt' },
    caloriesPer100: 59,
    proteinPer100: 10,
    carbsPer100: 4,
    fatPer100: 0,
  ...
  {
    id: 'i5',
    name: { vi: 'Khoai lang', en: 'Sweet potato' },
    caloriesPer100: 86,
    proteinPer100: 2,
    carbsPer100: 20,
    fatPer100: 0,
  ...
  {
    id: 'i6',
    name: { vi: 'Bông cải xanh', en: 'Broccoli' },
    caloriesPer100: 34,
    proteinPer100: 3,
    carbsPer100: 7,
    fatPer100: 0,
  ...
  {
    id: 'i7',
    name: { vi: 'Thịt bò nạc', en: 'Lean beef' },
    caloriesPer100: 250,
    proteinPer100: 26,
    carbsPer100: 0,
    fatPer100: 15,
  ...
  {
    id: 'i10',
    name: { vi: 'Hạt chia', en: 'Chia seeds' },
    caloriesPer100: 486,
    proteinPer100: 17,
    carbsPer100: 42,
    fatPer100: 31,
...
export const initialDishes: Dish[] = [
  ...
  },
  {
    ...
    tags: ['lunch', 'dinner'],
    ingredients: [{ ingredientId: 'i6', amount: 150 }],
  },
  {
    id: 'd5',
