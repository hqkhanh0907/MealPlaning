...
Last updated: 2026-05-16 (v1.7 — T14 added K.17: CDP/browser-based DOM inspection forbidden as verification primitive; allowlist limited to uiautomator + page-state inference; sub-agent briefs MUST forbid CDP explicitly).
