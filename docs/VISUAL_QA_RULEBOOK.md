...
Last updated: 2026-05-16 (v1.11 — polish pass 11: Settings sub-pages audit. Verified `body-edit`, `goals-edit`, `activity-edit` all already conform to canonical edit-page chrome (K.18): sage toolbar + back, sticky `<ion-footer>` LƯU full-width, tab bar hidden, body cream BG. No fixes needed — these were the reference pages dish-edit/ingredient-edit were normalized against in Pass 9. Activity-edit additionally renders a live `KẾT QUẢ TÍNH TOÁN` BMR/TDEE preview block, but the chrome scaffold matches. Pass 11 is a NO-OP audit pass — closes "audit consistency" item without code change. 802/802 tests, 9/9 guards green. Screenshots: `/tmp/qa-audit/v6/`.)
