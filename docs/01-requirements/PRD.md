...
- **Primary storage:** SQLite via sql.js (WebAssembly) — 27 bảng, schema version 3
- **Fallback/Bridge:** IndexedDB cho binary persistence
- **Offline-first:** Toàn bộ dữ liệu lưu local, không cần server
- **Schema:** Xem `src/services/schema.ts` cho chi tiết
