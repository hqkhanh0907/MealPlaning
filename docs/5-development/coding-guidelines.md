...
- `docs/4-architecture/data-model.md` — nếu thay đổi core domain types
- `docs/2-requirements/prd.md` — nếu thay đổi ảnh hưởng đến business logic
...
- `docs/4-architecture/sad.md` — cập nhật sequence descriptions
- Tài liệu test cases — cập nhật test case steps
...
- `docs/4-architecture/sequence-diagrams.md` — nếu flow thay đổi
- `docs/5-development/deployment.md` — nếu env vars mới
- Tài liệu test cases — nếu behavior thay đổi
