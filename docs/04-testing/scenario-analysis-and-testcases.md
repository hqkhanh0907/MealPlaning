...
- [Scenario 8: Settings & Config](#scenario-8-settings--config) (52 TCs)
...
- [Scenario 14: Grocery List](#scenario-14-grocery-list) (55 TCs)
...
Cài đặt ứng dụng: chuyển đổi theme (light/dark/system), ngôn ngữ (vi/en), backup/restore dữ liệu dạng JSON. Theme persist trong localStorage, system theme theo OS preference. Backup export 4 keys: ingredients, dishes, dayPlans, userProfile.
...
- **Steps**: 1. Tab Settings 2. Click "Export" 3. Kiểm tra file tải về
...
Tổng hợp danh sách mua sắm từ kế hoạch bữa ăn. Gom nhóm nguyên liệu giống nhau, cộng tổng khối lượng. Hỗ trợ check/uncheck, copy to clipboard, lọc theo scope (ngày/tuần/tháng). Celebration animation khi check hết.
