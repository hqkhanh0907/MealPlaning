...
| Chỉ số                     | Kết quả                                                                                                                                                                                                                                                                                                                                                                |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Unit Tests                 | **4,661 / 4,661 Pass** ✅                                                                                                                                                                                                                                                                                                                                              |
| Test Files                 | **184 / 184 Pass** ✅                                                                                                                                                                                                                                                                                                                                                  |
...
| Bugs mở                    | **0** ✅                                                                                                                                                                                                                                                                                                                                                               |
| Bugs đã đóng               | **22** (BUG-001, BUG-002, BUG-DOC-001, BUG-FAVICON-001, BUG-E2E-001, BUG-E2E-002, BUG-E2E-003, BUG-DM-001, BUG-TRANSLATE-001, BUG-EXPORT-001, BUG-NAN-001, BUG-NaN-MODAL, BUG-CALORIE-CONCAT, BUG-CARDIO-RADIO, BUG-I18N-WEEKOF, BUG-EXERCISE-NAME-HISTORY, BUG-I18N-MISSED-SESSIONS, BUG-STREAK-A11Y, BUG-DASHBOARD-NAV, BUG-DASHBOARD-BUTTONS, BM-BUG-01, BM-BUG-02) |
...
| 31.0    | 2026-07-21 | **BM Business Logic Audit**: 12 findings (1 HIGH, 1 MEDIUM, 2 LOW, 5 warnings, 3 info). Fixed BM-BUG-01 (4 stores missing SQLite persistence — ingredientStore, dayPlanStore, mealTemplateStore, userProfileStore) and BM-BUG-02 (negative target calories guard). Added 28 persistence tests. **184 test files / 4,661 tests ALL PASSING**, 100% pass rate. Commit: c45b4af. Detailed report: [BM-business-logic-audit.md](reports/BM-business-logic-audit.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
