...
### 2.2 RPE — Thang đo Cường độ Chủ quan
...
| # | Danh mục | Công thức | File tham khảo |
|---|---------|-----------|----------------|
| 1 | BMR | Mifflin-St Jeor | nutritionEngine.ts:33-44 |
| 2 | TDEE | BMR × Activity Multiplier | nutritionEngine.ts:46-51 |
| 3 | Caloric Target | TDEE ± Offset | nutritionEngine.ts:74-80 |
| 4 | Macros | Priority P→F→C | nutritionEngine.ts:82-114 |
| 5 | LBM | Weight × (1 − BF%) | nutritionEngine.ts:90-92 |
| 6 | Activity Blend | 0.7×Auto + 0.3×User | nutritionEngine.ts:63-72 |
| 7 | 1RM | Brzycki: W÷(1.0278−0.0278R) | trainingMetrics.ts:31-36 |
| 8 | Volume | Σ(Reps×Weight) | trainingMetrics.ts:5-8 |
| 9 | Weekly Sets | Base×Adjustments, clamped | volumeCalculator.ts:54-73 |
| 10 | Volume Distribution | Floor(total/n) + remainder | volumeCalculator.ts:75-83 |
| 11 | Progressive Overload | Rep max → +Weight, else +Rep | useProgressiveOverload.ts:48-75 |
| 12 | Plateau Detection | ≥3 weeks same weight (±2%) | useProgressiveOverload.ts:77-104 |
| 13 | Acute Fatigue | RPE ≥ 9.0 OR spike > 1.3x | useProgressiveOverload.ts:106-138 |
| 14 | Chronic Overtraining | ≥4 weeks declining volume | useProgressiveOverload.ts:140-176 |
| 15 | Deload | Sets × 0.6, Intensity × 0.9 | periodization.ts:72-79 |
| 16 | Current Week | Floor(elapsed / 7days) + 1 | useTrainingPlan.ts:98-102 |
| 17 | Cardio Burn | (Min×MET×Kg)÷60 | cardioEstimator.ts:14-23 |
| 18 | Strength Burn | (5.0×Kg×Min)÷60 | activityMultiplier.ts:150-151 |
| 19 | Duration Estimate | Warmup + Σ(sets×(40s+rest)+30s)/60 | TrainingPlanView.tsx:26-33 |
| 20 | Daily Score | Weighted average (5 factors) | scoreCalculator.ts:83-164 |
| 21 | Streak | Consecutive days + grace period | gamification.ts:58-176 |
| 22 | PR Detection | Current 1RM > historical best | gamification.ts:192-225 |
| 23 | Streak Bonus | Min(days × 5, 100) | scoreCalculator.ts:65-70 |
| 24 | Moving Average | Σ(weights)/n (min 3 entries) | useFeedbackLoop.ts:33-38 |
| 25 | Auto-Adjust | ±150 kcal per evaluation | useFeedbackLoop.ts:58-133 |
| 26 | Adherence | Hit%: actual in ±10% target | useFeedbackLoop.ts:135-179 |
| 27 | Max HR | 220 − Age (hoặc Tanaka) | Tiêu chuẩn ngành |
| 28 | HR Zones | Karvonen: Rest + %×(Max−Rest) | Tiêu chuẩn ngành |
| 29 | BMI | Weight ÷ Height² | Tiêu chuẩn ngành |
| 30 | FFMI | LBM ÷ Height² | Tiêu chuẩn ngành |
| 31 | Recovery Time | (AvgHR × Minutes) ÷ 200 | Tiêu chuẩn ngành |
| 32 | Wilks Score | Total × 500 ÷ polynomial(BW) | Tiêu chuẩn IPF |
