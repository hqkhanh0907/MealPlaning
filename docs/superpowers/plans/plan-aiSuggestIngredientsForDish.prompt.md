...
**Step 9.** Unit tests cho Preview component (_parallel with Step 10_)
...
**Step 10.** Unit tests cho DishEditModal integration (_parallel with Step 9_)
...
**Step 11.** Unit tests cho geminiService.suggestDishIngredients (_depends on Step 2_)
...
**Step 12.** Run ESLint, SonarLint, Coverage, SonarQube (_depends on Steps 9-11_)
**Step 13.** Commit + Build APK (_depends on Step 12_)
