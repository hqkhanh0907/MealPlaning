...
### 2.4 Off-Palette Stragglers (low priority)
...
### 2.5 Defined but Unused Token Families
...
### 2.7 Top Inconsistencies to Resolve
...
### 2.9 Contrast Issues (WCAG AA = 4.5:1 min)
